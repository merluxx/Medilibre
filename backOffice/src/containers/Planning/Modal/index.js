...
const mapStateToProps = (state) => ({
  ...
  newAppointmentColorPickerShow: state.admin.newAppointmentColorPickerShow,
  newAppointmentColor: state.admin.newAppointmentColor,
  ...
  newUserPublicEmail: state.newUser.publicEmailValue,
